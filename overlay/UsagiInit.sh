...
/ChordDHT-Node -uri $NODE_URI -tracker-url $TRACKER_URL -listen 8443 -tls-cert /tmp/ssl/selfsigned/server.crt -tls-key /tmp/ssl/selfsigned/server.key -skip-tls-verify &
